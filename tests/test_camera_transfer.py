...
def test_camera_transfer(single_image_os_file_getter, temp_os_output_file_writer):
    camera_transfer_operation = CameraTransfer(
        input_file_getter=single_image_os_file_getter,
...
def test_camera_transfer_duplicate(duplicate_image_os_file_getter, temp_os_output_file_writer):
    camera_transfer_operation = CameraTransfer(
        input_file_getter=duplicate_image_os_file_getter,
        model_short_names={"COOLPIX S9700": "S9700"},
        output_file_writer=temp_os_output_file_writer,
        hash_store=HashStore(filename=":memory:")
    )
...
def test_video_transfer(single_video_os_file_getter, temp_os_output_file_writer):
    camera_transfer_operation = CameraTransfer(
        input_file_getter=single_video_os_file_getter,
        model_short_names={},
        output_file_writer=temp_os_output_file_writer,
        hash_store=HashStore(filename=":memory:"),
    )
...
def test_video_transfer_duplicate(duplicate_video_os_file_getter, temp_os_output_file_writer):
    camera_transfer_operation = CameraTransfer(
        input_file_getter=duplicate_video_os_file_getter,
        model_short_names={},
        output_file_writer=temp_os_output_file_writer,
        hash_store=HashStore(filename=":memory:"),
    )
